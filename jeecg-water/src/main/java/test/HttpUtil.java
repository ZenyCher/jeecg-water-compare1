...
//			httpUrlConn.setRequestProperty("content-type", "text/html");
	...
	public static void main(String args[]){
		...
		jsonObject.put("tableName", "w_user_register");
		
		JSONObject jsonObject1=new JSONObject();
		jsonObject1.put("register_relation", "赵六");
		jsonObject1.put("register_phone", "13813451347");
		...
		JSONObject resp=HttpUtil.httpRequest("http://localhost:8080/jeecg/cgFormDataController.do?getForKeyAndValue","POST","body="+body,sign);
