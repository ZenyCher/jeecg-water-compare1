 ...
 */
@Entity
@Table(name = "w_view_record", schema = "")
@SuppressWarnings("serial")
public class WViewRecordEntity implements java.io.Serializable {
	/**主键*/
