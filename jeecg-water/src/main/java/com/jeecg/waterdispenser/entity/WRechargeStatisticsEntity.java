 ...
 */
@Entity
@Table(name = "w_recharge_statistics", schema = "")
@SuppressWarnings("serial")
public class WRechargeStatisticsEntity implements java.io.Serializable {
	/**主键*/
	...
	/**充值金额合计*/
	@Excel(name="充值金额合计")
	private java.math.BigDecimal rechargeStatistics;
	/**会员联系方式*/
	@Excel(name="会员联系方式")
	 ...
	 *@return: java.math.BigDecimal  充值金额合计
	 */
	@Column(name ="RECHARGE_STATISTICS",nullable=true,length=32)
	public java.math.BigDecimal getRechargeStatistics(){
		return this.rechargeStatistics;
	}

	/**
	 *方法: 设置java.math.BigDecimal
	 *@param: java.math.BigDecimal  充值金额合计
	 */
	public void setRechargeStatistics(java.math.BigDecimal rechargeStatistics){
