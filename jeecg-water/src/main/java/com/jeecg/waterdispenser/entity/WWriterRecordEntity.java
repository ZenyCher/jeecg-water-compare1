 ...
 * @date 2017-08-11 19:57:49
 * @version V1.0   
 *
 */
@Entity
@Table(name = "w_writer_record", schema = "")
@SuppressWarnings("serial")
public class WWriterRecordEntity implements java.io.Serializable {
	/**主键*/
	...
	/**充值水量*/
	@Excel(name="充值水量")
	private java.lang.String waterNum;
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  充值水量
	 */
	@Column(name ="WATER_NUM",nullable=true,length=32)
	public java.lang.String getWaterNum(){
		return this.waterNum;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  充值水量
	 */
	public void setWaterNum(java.lang.String waterNum){
