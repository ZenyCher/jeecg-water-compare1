...
<t:datagrid  pagination="false"  name="packageList" title="套餐"  actionUrl="wuserMemberController.do?normalPackage" idField="packageId" checkbox="true" showRefresh="false"  fit="true"  queryMode="group" onLoadSuccess="initCheck">
