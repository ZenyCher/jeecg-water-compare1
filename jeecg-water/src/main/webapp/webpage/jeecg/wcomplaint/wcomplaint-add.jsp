...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="wComplaintController.do?doAdd" >
		...
		<fieldset class="step">
			...
			<div class="form">
		      <label class="Validform_label">提交时间:</label>
					  <input id="complaintTime" name="complaintTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"
									ignore="checked"
					     datatype="*"/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">处理完成时间:</label>
		     	 <input id="complaintEndtime" name="complaintEndtime" type="text" style="width: 150px" class="inputxt" 
									ignore="ignore"
									 />
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">投诉与建议回复:</label>
				 <textarea id="complaintMsg" style="width:600px;" class="inputxt" rows="6" name="complaintMsg" 
				ignore="ignore"
				 ></textarea>
		      <span class="Validform_checktip"></span>
		    </div>
