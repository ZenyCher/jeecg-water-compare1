...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="wuserMemberController.do?doUpdate" callback="jeecgFormFileCallBack@Override">
...
<!-- 			<div class="form"> -->
<!-- 		      <label class="Validform_label">会员类型:</label> -->
<!-- 				<select id="memberType" name="memberType"> -->
<%-- 				 	<option <c:if test="${wUserMemberPage.memberType eq '0'}">selected</c:if> value="0">线下签约</option> --%>
<%-- 					<option <c:if test="${wUserMemberPage.memberType eq '1'}">selected</c:if> value="1">商城下单</option> --%>
<!-- 				</select>       -->
<!-- 		      <span class="Validform_checktip"></span> -->
<!-- 		    </div> -->
		    <div class="form">
		      <label class="Validform_label">初始水量L:</label>
				  ...
				  value='${wUserMemberPage.memberInitialWater}'/>
		      <span class="Validform_checktip"></span>
		    </div>  
		   	<div class="form">
		      <label class="Validform_label">附件合同:</label>
					<table></table>
					<t:webUploader auto="true" name="menberContract" fileNumLimit="1" pathValues="${wUserMemberPage.menberContract }"></t:webUploader>
			...
			<div class="form">
		      <label class="Validform_label">附件证件:</label>
					<table></table>
					<t:webUploader auto="true" name="menberCertificates" fileNumLimit="1" pathValues="${wUserMemberPage.menberCertificates }"></t:webUploader>
					<span class="Validform_checktip Validform_right" style="display: none;">证件已上传</span>
		      <span class="Validform_checktip"></span>
		    </div>
		    <div class="form">
		      <label class="Validform_label">净水器型号:</label>
		     	<input id="memberDeviceType" name="memberDeviceType" type="text" style="width: 150px" class="inputxt"  datatype="*" ignore="ignore" 
		      ...
		      <span class="Validform_checktip"></span>
		    	...
		    	<div class="form">
			    	<label class="Validform_label">初装套餐:</label>
				    	<input id="pakcageName" name="pakcageName" type="text" style="width: 150px" class="inputxt" ignore="checked" datatype="*" value='${wUserMemberPage.memberPackageMsg}'/>
						<input id="memberPackageId" name="memberPackageId" type="hidden" value='${wUserMemberPage.memberPackageId}'/>
				...
				<div class="form">
					<label class="Validform_label">平常套餐:</label>
						<input id="packageMode" name="packageMode" type="text" style="width: 150px" class="inputxt" ignore="checked" datatype="*" value='${wUserMemberPage.memberNormalPackageMsg}'/>
						<input id="memberNormalPackageId" name="memberNormalPackageId" type="hidden" value='${wUserMemberPage.memberNormalPackageId}'/>
