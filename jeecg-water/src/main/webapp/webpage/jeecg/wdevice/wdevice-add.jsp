...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wdeviceController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="deviceModel" name="deviceModel" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" ignore="checked"
					     	  onclick="popupClick(this,'id,device_type,device_name,device_filter_num','deviceTypeId,deviceModel,deviceName,filterNember','device_type');"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="filterNember" name="filterNember" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="n" ignore="checked" readOnly="true"/>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="deviceTime" name="deviceTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()" 
					      						 datatype="*"  
					      						ignore="checked"
					      						/>    
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="deviceCode" name="deviceCode" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
