...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wrechargeController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="memberName" name="memberName" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${wrechargePage.memberName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="deviceId" name="deviceId" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${wrechargePage.deviceId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="memberAddress" name="memberAddress" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${wrechargePage.memberAddress}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="rechargeSum" name="rechargeSum" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${wrechargePage.rechargeSum}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="rechargeTime" name="rechargeTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  datatype="*" 
									  ignore="checked"
									    value='<fmt:formatDate value='${wrechargePage.rechargeTime}' type="date" pattern="yyyy-MM-dd"/>'>
							<span class="Validform_checktip"></span>
