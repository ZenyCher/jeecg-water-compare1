...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="wFilterController.do?doAdd" >
		...
		<fieldset class="step">
			...
			<div class="form">
		      <label class="Validform_label">生产日期:</label>
					  <input id="filterTime" name="filterTime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"
									ignore="checked"
					     datatype="*"/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">导入时间:</label>
					  <input id="filterImporttime" name="filterImporttime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"
									ignore="checked"
					     datatype="*"/>
		      <span class="Validform_checktip"></span>
		    </div>
