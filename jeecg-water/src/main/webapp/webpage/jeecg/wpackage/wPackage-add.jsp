...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="wPackageController.do?doAdd" >
...
<!-- 		    </div> -->
		    ...
		    <div class="form">
		      ...
		      <input type="text" id="packageDescribe" name="packageDescribe" style="width:150px" readOnly="true"/>
		      <span class="Validform_checktip"></span>
		    </div>
<!-- 			<div class="form"> -->
<!-- 		      <label class="Validform_label">优惠规则描述:</label> -->
		    ...
		    <div class="form">
		      <label class="Validform_label">充值类型:</label>
				<select id="packageClass" name="packageClass" ignore="checked" datatype="*">
					<option value="0">充积分</option>
					<option value="1">充水量</option>
				</select>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">状态:</label>
					<t:dictSelect field="packageState" type="list" datatype="*"
						typeGroupCode="package" defaultVal="${wPackagePage.packageState}" hasLabel="false"  title="状态" ></t:dictSelect>     
		      <span class="Validform_checktip"></span>
		    </div>
	    </fieldset>
  </t:formvalid>
