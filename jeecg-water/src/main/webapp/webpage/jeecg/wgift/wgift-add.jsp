...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wGiftController.do?doAdd" callback="jeecgFormFileCallBack@Override">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						    	...
						    	<textarea name="giftDescribe" id="giftDescribe" style="width: 650px;height:300px"></textarea>
							    <script type="text/javascript">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="giftChange" name="giftChange" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="giftSum" name="giftSum" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="giftSurplus" name="giftSurplus" type="text" style="width: 150px" class="inputxt" 
					     	  datatype="*" 
					     	  ignore="checked"
					     	  />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
						<table></table>
						<t:webUploader auto="true" name="giftImage" fileNumLimit="3" type="image"></t:webUploader>
  ...
  <script src = "jeecg/wgift/wGift.js"></script>		
	  	<script type="text/javascript">
