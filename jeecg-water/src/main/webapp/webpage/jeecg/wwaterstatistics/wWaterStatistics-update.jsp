...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wWaterStatisticsController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						<input id="memberName" name="memberName" type="text" style="width: 150px" class="searchbox-inputtext"  datatype="*" 
						ignore="checked"
						 onclick="inputClick(this,'member_name','user_register')" value='${wWaterStatisticsPage.memberName}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="waterStatistics" name="waterStatistics" type="text" style="width: 150px" class="inputxt"  datatype="*" 
						     	 ignore="checked" 
						     	 value='${wWaterStatisticsPage.waterStatistics}'>
							<span class="Validform_checktip"></span>
