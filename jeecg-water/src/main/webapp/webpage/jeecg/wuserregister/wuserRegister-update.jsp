...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="wuserRegisterController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${wuserRegisterPage.registerRelation}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${wuserRegisterPage.registerType}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 ...
						     	 ignore="ignore" 
						     	 value='${wuserRegisterPage.registerState}'>
							<span class="Validform_checktip"></span>
