...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="werectorController.do?doUpdate" >
			...
			<div class="form">
		      <label class="Validform_label">安装公司:</label>
		     	 <input id="erectorCompany" name="erectorCompany" type="text" style="width: 150px" class="inputxt" 
									ignore="checked"
		     	  datatype="*"  value='${wErectorPage.erectorCompany}'/>
			...
			<div class="form">
		      <label class="Validform_label">安装负责人:</label>
		     	 <input id="erectorPerson" name="erectorPerson" type="text" style="width: 150px" class="inputxt" 
									ignore="checked"
		     	  datatype="*"  value='${wErectorPage.erectorPerson}'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">联系方式:</label>
		     	 <input id="erectorPhone" name="erectorPhone" type="text" style="width: 150px" class="inputxt" 
									ignore="checked"
		     	  datatype="m"  value='${wErectorPage.erectorPhone}'/>
		      <span class="Validform_checktip"></span>
		    </div>
		    <div class="form">
		      <label class="Validform_label">固定电话:</label>
		     	 <input id="erectorFixedline" name="erectorFixedline" type="text" style="width: 150px" class="inputxt" 
		     	  datatype="n"  value='${wErectorPage.erectorFixedline}'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">服务区域:</label>
		     	 <input id="erectorRegion" name="erectorRegion" type="text" style="width: 150px" class="inputxt" 
									ignore="checked"
		     	  datatype="*"  value='${wErectorPage.erectorRegion}'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">对应后台账号:</label>
			<input id="erectorAdmin" name="erectorAdmin" type="text" style="width: 150px" class="searchbox-inputtext"
					ignore="ignore"
			  value='${wErectorPage.erectorAdmin}' datatype="*" onclick="inputClick(this,'erector_admin','user_msg')" value='${wErectorPage.erectorAdmin}'/>			 
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">创建日期:</label>
					  <input id="createDate" name="createDate" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker()"  datatype="*"
									ignore="checked"
		      						  value='<fmt:formatDate value='${wErectorPage.createDate}' type="date" pattern="yyyy-MM-dd"/>'/>   
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">备注:</label>
		     	 <input id="erectorRemarks" name="erectorRemarks" type="text" style="width: 150px" class="inputxt" 
									ignore="ignore"
		     	   value='${wErectorPage.erectorRemarks}'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
