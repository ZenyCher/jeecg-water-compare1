...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="false" title="jeecg_demo" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入-提交按钮" icon="icon-add" url="jeecgListDemoController.do?addWithbtn" onclick="addWithbtn(id)" funname="addWithbtn" width="770"></t:dgToolBar>
...
function addWithbtn(title,addurl,gname,width,height,id){
	alert(id);
