                 ...
                 <div class="alert alert-warning alert-dismissible" role="alert" id="errMsgContiner">
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix">
                        ...
                        <i id="forget_pw" onclick="forget_pw()" class="pull-right" style="color:#0000FF;font-size:110%;cursor:pointer;">忘记密码</i>
                      </div>
                      <div class="space-4"></div>
	                <div class="clearfix text-center">
	                	<button type="button" id="but_login"  onclick="checkUser()" class="width-35 .center-block btn btn-sm btn-primary">
...
//设置cookie
  ...
  //忘记密码
  function forget_pw(){
	  window.location.replace('webpage/login/modifypassword.jsp');
  }
</script>
<%=lhgdialogTheme %>
</body>
